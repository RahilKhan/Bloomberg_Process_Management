...
<html lang="en">
	...
	<body>   
		...
		<main>
			...
			<!-- sideNav bar -->
			<!-- 
			<div class="modal fade left show" id="fluidModalLeftInfoDemo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="false" style="display: block;">
				<div class="modal-dialog modal-full-height modal-left modal-notify modal-info" role="document">
					<div class="modal-content">
						...
						<div class="modal-footer">
							<a type="button" class="btn btn-primary-modal waves-effect waves-light">Get it now <i class="fa fa-diamond ml-1"></i></a>
